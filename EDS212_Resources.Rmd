...
### titling your graph  "**y-axis variable vs.** x-axis variable."
...
```{r}
#add this to control scale and labels if you want them to be continuous
#scale_x_continuous(breaks=c(2008:2018), labels=c(2008:2018),limits=c(2008,2018)
```

## Factor reorder

allows you to change away from the default order
